...
转化数据集
# train
python scripts/coco2yolo.py --coco_img_dir $COCO_DIR/train2017/ --coco_ann_file $COCO_DIR/annotations/instances_train2017.json --yolo_names_file ./cfg/coco/coco.names --output_dir ./data/ --output_name train2017 --output_img_prefix /home/disk1/Scheaven/start-yolov4/data/train2017
# valid
python scripts/coco2yolo.py --coco_img_dir $COCO_DIR/val2017/ --coco_ann_file $COCO_DIR/annotations/instances_val2017.json --yolo_names_file ./cfg/coco/coco.names --output_dir./data/ --output_name val2017 --output_img_prefix /home/disk1/Scheaven/start-yolov4/data/val2017
'''
...
def coco2yolo(coco_img_dir, coco_ann_file, yolo_names_file, output_dir,
  ...
  for cat_id in cat_ids:
    ...
    for img_id in tqdm.tqdm(img_ids):
      ...
      with open(img_dst_txt, "a") as txt:
