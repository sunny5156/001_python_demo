...
for xmlFile in files: #遍历文件夹
    if not os.path.isdir(xmlFile): #判断是否是文件夹,不是文件夹才打开
        ...
        for o in ob:
            ...
            if name[0].firstChild.data == "have_mask":
                name[0].firstChild.data = 'face_mask'
            elif name[0].firstChild.data == "no_mask":
                name[0].firstChild.data = 'face'
